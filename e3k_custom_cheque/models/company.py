...
class ResCompany(models.Model):
  ...
  check_background = fields.Selection(
    [('show', 'Show check background'), ('hidden', 'Hide check background')],
    string="Background", required=True, default="hidden")

  date_format = fields.Char("10: Date Format ", default='%d%m%Y')
  payment_date_top = fields.Integer('15: Payment date : Top distance', default=625)
  ...
  display_date_format_top = fields.Integer('35: Date format text : Top distance', default=650)
  ...
  amount1_top = fields.Integer('50: Payment amount 1 : Top distance', default=705)
  amount1_left = fields.Integer('55: Payment amount 1 : Left distance', default=100)

  amount2_top = fields.Integer('60: Payment amount 2 : Top distance', default=710)
  amount2_right = fields.Integer('65: Payment amount 2 : Right distance', default=90)

  amount_in_world_font_size = fields.Integer('80: Amount in world font size', default=25)

  address_top = fields.Integer('70: Address : Top distance', default=740)
  ...
  check_table1_top = fields.Integer('105: Check table 1: Top distance', default=-270)
  check_table1_left = fields.Integer('110: Check table 1: Left distance', default=0)

  check_table2_top = fields.Integer('115: Check table 2: Top distance', default=375)
  check_table2_left = fields.Integer('120: Check table 2: Left distance', default=0)

  table_1_partner_name_top = fields.Integer('125: Table-1 Partner name: Top distance', default=--300)
  table_1_partner_name_left = fields.Integer('130: Table-1 Partner name: Left distance', default=400)

  table_1_payment_date_top = fields.Integer('135: Table-1 Payment date: Top distance', default=-300)
  table_1_payment_date_left = fields.Integer('140: Table-1 Payment date: Left distance', default=250)

  table_1_amount_top = fields.Integer('145: Table-1 Amount: Top distance', default=100)
  table_1_amount_left = fields.Integer('150: Table-1 Amount: Left distance', default=300)

  table_2_partner_name_top = fields.Integer('155: Table-2 Partner name: Top distance', default=350)
  table_2_partner_name_left = fields.Integer('160: Table-2 Partner name: Left distance', default=400)

  table_2_payment_date_top = fields.Integer('165: Table-2 Payment date: Top distance', default=350)
  table_2_payment_date_left = fields.Integer('170: Table-2 Payment date: Left distance', default=250)

  table_2_amount_top = fields.Integer('175: Table-2 Amount: Top distance', default=800)
  table_2_amount_left = fields.Integer('180: Table-2 Amount: Left distance', default=300)
  ...
  table_2_check_number_top = fields.Integer('195: Table-2 Check number: Top distance', default=350)
